...
<section class="py-20 bg-gradient-to-b from-[#1a1a2e] via-[#16213e] to-[#1a1a2e] relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10 overflow-hidden"> <!-- Added overflow-hidden to container -->
        <!-- Section Header -->
        ...
        <!-- Swiper Slider -->
        <div class="swiper-container overflow-hidden"> <!-- Ensure swiper container is clipped -->
