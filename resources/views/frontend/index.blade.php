...
@section('content')
    ...
    <section class="relative h-screen overflow-hidden">
        ...
        <video autoplay muted loop playsinline class="absolute w-full h-full object-cover filter brightness-75">
            <source src="{{ asset('asset/images/855139-hd_1920_1080_30fps.mp4') }}" type="video/mp4">
        </video>
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-[#16213e] p-8 rounded-xl shadow-2xl border border-white/5">
                    ...
                    <p class="text-gray-300">
                        "The attention to detail in the room design and amenities is exceptional. I felt pampered from the
                        moment I arrived."
                    </p>
                    <div class="mt-6 flex space-x-1">
                        <i class="fas fa-star text-[#D4A017]"></i>
                ...
                <div class="bg-[#16213e] p-8 rounded-xl shadow-2xl border border-white/5">
                    ...
                    <p class="text-gray-300">
                        "The perfect place for a business trip. Fast Wi-Fi, comfortable workspace, and top-notch facilities.
                    ...
                    <div class="mt-6 flex space-x-1">
                        ...
                        <i class="fas fa-star text-[#D4A017]"></i>
                        <i class="fas fa-star text-[#D4A017]"></i>
                        <i class="fas fa-star-half-alt text-[#D4A017]"></i>
                    </div>
                </div>
            </div>
        </div>
